    ...
    const tanggalAkses = new Date(2025, 1, 14, 20, 20, 0); // Tanggal 8 Februari 2025 jam 10:00
    const tanggalSekarang = new Date();

    // Mengecek apakah waktu sekarang sudah lebih besar atau sama dengan waktu yang ditentukan
    if (tanggalSekarang >= tanggalAkses) {
      document.getElementById('body').innerHTML;
  } else {
      // Mengosongkan konten dari elemen dengan ID tertentu
      document.body.innerHTML = "<h1 style='display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; padding: 0 10px; text-align: center;'>Buka saat tanggal 16 ya njing!</h1>";
  }
